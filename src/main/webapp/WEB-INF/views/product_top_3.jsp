...
<%@ include file="layout/top.jsp" %>
	...
	<div class="product_view">
		<h2>[단독상품]Disc Jockey Sweatshirt(BLACK)</h2>
		<table>
			<colgroup>
			<col style="width:px;">
			</col>
		...
		<div class="img">
			<ul>
			<img src="${path }/resources/images/Item/TOP/TOP3.PNG" alt="" style="width: 355px; height: 355px;">
			</ul>
			<ul>
				<li class="on"><a href="#a"><img src="${path }/resources/images/Item/TOP/TOP3.PNG" alt=""></a></li>
				<li class="on"><a href="#a"><img src="${path }/resources/images/Item/TOP/TOP3.PNG" alt=""></a></li>
			</ul>
		</div>
		<div class="btns">
