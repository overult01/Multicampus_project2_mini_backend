...
<body>
	...
	<div class="product_view">
		<h2>[1+1] CREW NECK LOOSE FIT SWEATER [10COLOR]</h2>
		<table>
			<colgroup>
			<col style="width:px;">
			</col>
		...
		<div class="img">
			<ul>
			<img src="${path }/resources/images/Item/TOP/TOP2.PNG" alt="" style="width: 355px; height: 355px;">
			</ul>
			<ul>
				<li class="on"><a href="#a"><img src="${path }/resources/images/Item/TOP/TOP2.PNG" alt=""></a></li>
				<li class="on"><a href="#a"><img src="${path }/resources/images/Item/TOP/TOP2.PNG" alt=""></a></li>
			</ul>
		</div>
		<div class="btns">
