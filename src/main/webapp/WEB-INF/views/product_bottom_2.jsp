...
<%@ include file="layout/top.jsp" %>
	...
	<div class="product_view">
		...
		<div class="img">
			<ul>
			<img src="${path }/resources/images/Item/BOTTOM/BOTTOM2.PNG" alt="" style="width: 355px; height: 355px;">
			</ul>
			<ul>
				<li class="on"><a href="#a"><img src="${path }/resources/images/Item/BOTTOM/BOTTOM2.PNG" alt=""></a></li>
				<li class="on"><a href="#a"><img src="${path }/resources/images/Item/BOTTOM/BOTTOM2.PNG" alt=""></a></li>
			</ul>
		</div>
		<div class="btns">
			<a href="#" class="btn1">찜하기</a>	
