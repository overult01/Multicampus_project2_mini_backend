			...
			<div id = "main-container">		
				<section>
					<article>
						...
						<A href="inquire.html"><button type="button" class="btn btn-dark btn-sm" id = "inquire">고객센터</button></A>
						<A href="inquire.html"><button type="button" class="btn btn-dark btn-sm" id = "inquire">공지사항</button></A>
