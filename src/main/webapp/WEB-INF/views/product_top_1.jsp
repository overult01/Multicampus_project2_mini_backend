...
<%@ include file="layout/top.jsp" %>
	...
	<div class="product_view">
		<h2>[1+1] 뉴해빗 - 21FW MTM_BEST PACKAGE</h2>
		<table>
			<colgroup>
			<col style="width:px;">
			</col>
		...
		<div class="img">
			<ul>
			<img src="${path }/resources/images/Item/TOP/TOP1.PNG" alt="" style="width: 355px; height: 355px;">
			</ul>
			<ul>
				<li class="on"><a href="#a"><img src="${path }/resources/images/Item/TOP/TOP1.PNG" alt=""></a></li>
				<li class="on"><a href="#a"><img src="${path }/resources/images/Item/TOP/TOP1.PNG" alt=""></a></li>
			</ul>
		</div>
		<div class="btns">
			<a href="#a" class="btn1">찜하기</a>	
			<a href="http://localhost:8080/mall/order" class="btn2">구매하기</a>		
		</div>
	</div>
