...
<%@ include file="layout/top.jsp" %>
	...
	<div class="product_view">
		...
		<div class="img">
			<ul>
			<img src="${path}/resources/images/Item/BOTTOM/BOTTOM1.jpg" alt="" style="width: 355px; height: 355px;">
			</ul>
			<ul>
				<li class="on"><a href="#a"><img src="${path}/resources/images/Item/BOTTOM/BOTTOM1.jpg" alt=""></a></li>
				<li class="on"><a href="#a"><img src="${path}/resources/images/Item/BOTTOM/BOTTOM1.jpg" alt=""></a></li>
			</ul>
		</div>
		<div class="btns">
